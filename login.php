...
if(!empty($_POST))
{
 if(isset($_POST['username'],$_POST['password']))
 {
	...
	else
	{
		...
		<br><?php
		echo "New User? Register now!"; ?> <input type="button" name="register" value="REGISTER" onclick="window.location.href='register.php'" > <?php
...
<div class="container-fluid">
	<div class="right">
		...
		<a href="register.php" class="regbtn link1" role="button">Sign Up</a>
		...
		<form action="" method="post" id="myform">
			<p class="website">WEBSITE</p>
  			...
  			<div class="form-group form_row">
  				<input type="submit" class="form-control signin" value="Sign in" placeholder="Sign In" name="login">
			</div>
